...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 15 juin 2022 à 16:24
...
INSERT INTO `page` (`id`, `id_utilisateur`, `cle`, `titre`, `contenu`, `icone`) VALUES
(1, 1, 'accueil', 'Accueil', '&lt;p&gt;Bienvenue sur l&amp;#39;application PortfolioSIO !&lt;/p&gt;&lt;p&gt;Cet outil &amp;agrave; destination des &amp;eacute;tudiants du BTS SIO, SISR et SLAM, permet de faciliter la r&amp;eacute;alisation de son portfolio pour l&amp;#39;&amp;eacute;preuve E4 qui consiste &amp;agrave; pr&amp;eacute;senter les comp&amp;eacute;tences acquises sur les deux ann&amp;eacute;es de la formation.&lt;/p&gt;', 'las la-home');
...
--
-- AUTO_INCREMENT pour la table `acquis`
--
ALTER TABLE `acquis`
